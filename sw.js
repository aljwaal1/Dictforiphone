const CACHE='qamoosi-pwa-v6';
const ASSETS=['./','./index.html','./styles.css','./excel-import.css','./app.js','./v2-learning.js','./excel-import.js','./manifest.webmanifest','./assets/data/words.json','./icons/icon-192.svg','./icons/icon-512.svg'];
