const CACHE='qamoosi-pwa-v5';
const ASSETS=['./','./index.html','./styles.css','./app.js','./v2-learning.js','./manifest.webmanifest','./assets/data/words.json','./icons/icon-192.svg','./icons/icon-512.svg'];
